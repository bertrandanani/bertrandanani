...
GET /books/id (selectionner un livres en particulier)
POST /books (Créer une nouvelle livres)
...
########################################
    ...
    def add_book():
        ...
        book = Book(id_book=id, isbn=isbn, titre=new_titre, date_publication=new_date,
